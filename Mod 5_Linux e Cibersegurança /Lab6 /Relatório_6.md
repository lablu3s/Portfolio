...
Aqui o passo defensivo recomendado é remover as chaves desconhecidas/suspeitas do ficheiro authorized_keys (mantendo apenas as estritamente necessárias para a gestão do servidor). Lembrando que foi adicionada ao authorized_keys a nossa própria chave local (id_ed25519.pub).
